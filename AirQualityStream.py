...
def produce_to_kafka(producer, kafka_topic, weather_data):
    producer.produce(kafka_topic, value=json.dumps(weather_data))
...
def main(output_path, kafka_bootstrap_servers, kafka_topic):
    ...
    # Fetch weather data and produce to Kafka every 5 seconds
    while True:
...
if __name__ == "__main__":
    ...
    # The output path, Kafka bootstrap servers, Kafka topic, API key, and city are passed as arguments
